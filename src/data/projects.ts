...
print(stats)`,
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          'count()不包括NaN，size()包括',
          'count()包括NaN，size()不包括',
          '没有区别',
          'count()返回Series，size()返回DataFrame',
        ],
...
export const difficultyColors: Record<string, string> = {
  '入门': 'bg-neon-green/20 text-neon-green border-neon-green/50',
  '初级': 'bg-neon-blue/20 text-neon-blue border-neon-blue/50',
  '中级': 'bg-neon-orange/20 text-neon-orange border-neon-orange/50',
  '高级': 'bg-neon-purple/20 text-neon-purple border-neon-purple/50',
};
